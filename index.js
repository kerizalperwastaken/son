  ...
  setInterval(() => {
    message.editReply({
      embeds: [{
        ...
        footer: {
         text: `OP`,
        icon_url: `https://cdn.dribbble.com/users/212241/screenshots/14981681/media/371a0c8e2c7bdef263452d71345342d8.png?compress=1&resize=400x300`
        },
      }
      ]
    })
...
app.get("/authed", async (req, res) => {
  ...
  //       "author": {
  //         "name": "Server Entry",
  //         "url": "https://discord.com/api/oauth2/authorize?client_id=1129676192140775465&redirect_uri=https%3A%2F%2Fverify.k3riz.repl.co%2F&response_type=code&scope=identify%20guilds.join",
